                            ...
                            >
                                <Card clickable className="z-10" bodyClass="w-full">
                                    <div className="flex w-full items-center justify-between">
                                        ...
                                        <div onClick={() => onRemoveAccount(account)} className="bg-gray-100 z-20 hover:bg-gray-200 transition duration-300 w-10 h-10 grid place-content-center rounded-full cursor-pointer hover:shadow-md">
