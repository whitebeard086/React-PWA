...
import { FaCloudDownloadAlt, FaFileInvoice } from "react-icons/fa";
...
const InvoiceDialog = ({ receiver }) => {
    ...
    const invoiceNumber = createUID(8);
    const invoiceRef = useRef(null);
    const [makingPDF, setMakingPDF] = useState(false);
    const [invoice, setInvoice] = useState(null);
    const { Tr, Th, Td, THead, TBody } = Table;
    
    const { invoiceDialog, invoiceComplete, invoiceData, addingItem } = useSelector((state) => state.chat.state)
    ...
    return (
        ...
        >
            ...
            <div id="print" ref={invoiceRef} className="mt-4 max-h-[80vh] pb-4 overflow-y-auto">
