...
import { getDashboardData, setServiceCompletedDash, setServiceConfirmedDash } from "./store/dataSlice";
...
const ProviderDashboard = () => {
    ...
    const { serviceCompleted, serviceConfirmed } = useSelector((state) => state.dashboard.data)
