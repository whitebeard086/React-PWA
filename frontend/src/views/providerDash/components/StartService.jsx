...
import { setStartStatusDash, startService } from "../store/dataSlice"
...
const StartService = () => {
    ...
    const { startingService, startStatus, booking } = useSelector((state) => state.dashboard.data)
    const { startServiceDialog, bookingID } = useSelector((state) => state.dashboard.state)
    ...
    useEffect(() => {
        ...
        dispatch(setStartStatusDash("idle"));
