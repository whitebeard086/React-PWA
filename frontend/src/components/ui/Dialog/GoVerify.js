        ...
        >
            <div className="px-6 pb-6 pt-2 flex">
                ...
                <div className="ml-4 rtl:mr-4">
					<h5 className="mb-2">Full Identity Verification Required!</h5>
					<p>We need to fully verify your identity before you can complete this action. Please take a moment to complete your identity verification.</p>
				</div>
            </div>
            <div className="text-right px-6 py-3 bg-gray-100 dark:bg-gray-700 rounded-bl-lg rounded-br-lg">
				<Button size="sm" className="ltr:mr-2 rtl:ml-2" onClick={onCancel}>
					Cancel
				</Button>
				<Button
					size="sm"
